...
async function testFrontendFlow() {
  ...
  await testApiCall('/api/packages?destination=Dubai%2C+United+Arab+Emirates&destination_type=city&page=1&page_size=20');
  ...
  await testApiCall('/api/packages?destination=Europe&destination_type=region&page=1&page_size=20');
