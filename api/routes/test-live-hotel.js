        ...
        results: {
          ...
          contentData: contentData
            ? {
                ...
                images: {
                  ...
                  sampleImages: contentData.images
                    ? contentData.images.slice(0, 3).map((img) => ({
                        url: img.url,
                        type: img.type,
                      }))
                    : [],
                  allImageUrls: contentData.images
                    ? contentData.images.map((img) => img.url)
                    : [],
                },
                amenities: {
                  count: contentData.amenities
                    ? contentData.amenities.length
                    : 0,
                  list: contentData.amenities
                    ? contentData.amenities.map((a) => a.name)
                    : [],
                },
          ...
          combinedResult: {
            ...
            description:
              ...
              `Experience luxury at ${firstHotel.name}`,
            currentPrice: firstHotel.currentPrice,
            totalPrice: firstHotel.totalPrice,
            rating: contentData?.rating || 4.2,
            amenities: contentData?.amenities?.map((a) => a.name) || [
              "WiFi",
              "Pool",
              "Restaurant",
            ],
