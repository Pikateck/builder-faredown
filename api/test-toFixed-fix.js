...
const testStatsObject = () => {
  ...
  try {
    ...
    console.log(
      `   - avg_rating.toFixed(1): ${defaultStats.avg_rating.toFixed(1)}`,
    );
  ...
  try {
    ...
    console.log(
      `   - avg_rating.toFixed(1): ${apiStats.avg_rating.toFixed(1)}`,
    );
  ...
  console.log(
    "📝 PackageManagement component should now load without crashing.",
  );
};
