...
function displayBanner() {
  ...
  log.divider();
  console.log(`${colors.magenta}🚀 Starting Faredown API Server...${colors.reset}`);
  ...
  console.log(`${colors.green}📍 Port: ${process.env.PORT || 3001}${colors.reset}`);
  log.divider();
}
...
function displayServerInfo() {
  ...
  log.divider();
  console.log(`${colors.green}📍 Server URL: http://localhost:${port}${colors.reset}`);
