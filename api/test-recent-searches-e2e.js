...
async function testEndToEndFlow() {
  ...
  try {
    ...
    console.log(
      `   Initial searches: ${Array.isArray(initialResponse.data) ? initialResponse.data.length : "invalid"}\n`,
    );
    ...
    console.log(
      `   Recent searches found: ${Array.isArray(updatedResponse.data) ? updatedResponse.data.length : "invalid"}`,
    );
    ...
    if (
      ...
      console.log(
        `   ✅ Search: ${search.query.from.name} → ${search.query.to.name} (${search.query.tripType})\n`,
      );
    }
