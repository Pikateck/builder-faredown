...
async function testEndpoints() {
  ...
  try {
    ...
    await axios.post(`${baseURL}/api/pricing/quote`, {
      module: "air",
      origin: "BOM", 
      destination: "JFK",
      serviceClass: "Y",
    ...
    const diffResponse = await axios.get(`${baseURL}/api/pricing/diff?journeyId=${journeyId}`);
    ...
    const previewResponse = await axios.get(`${baseURL}/api/pricing/rules/preview?module=air&origin=BOM&destination=JFK&serviceClass=Y&userType=b2c&baseFare=500`);
