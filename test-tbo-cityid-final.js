  ...
  try {
    ...
    if (Array.isArray(cities) && cities.length > 0) {
      ...
      if (dubai) {
        ...
        console.log("Sample cities:", cities.slice(0, 5).map(c => c.CityName || c.Name));
      }
    } else {
...
async function main() {
  console.log("\n╔" + "═".repeat(78) + "╗");
  console.log("║" + " ".repeat(25) + "TBO CITYID RESOLUTION" + " ".repeat(32) + "║");
  ...
  if (dubai) {
    ...
    // Save to file
    fs.writeFileSync("dubai-cityid.json", JSON.stringify({
      cityId: cityId,
      dubai: dubai,
    ...
    console.log("  ❌ CityList with TokenId: " + (tokenId ? "Failed" : "Not tested (no TokenId)"));
    console.log("\n🔍 DIAGNOSIS:");
    console.log("  The TBO static data API is not accessible via the documented endpoints.");
    console.log("  This could mean:");
    console.log("    1. Static data requires portal download (NewCityListHotel.rar)");
    ...
    console.log("  1. Log into TBO B2B portal: https://b2b.travelboutiqueonline.com");
