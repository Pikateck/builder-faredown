...
/**
 * Scenario 5: Short Stay Hotel Booking
 * - Destination: Pune, India
 * - Guests: 1 Adult
 * - Duration: 1 night (Dec 20-21, 2025)
 * - Focus: Edge case - solo traveler, minimum night stay
 */
...
const SCENARIO_ID = 5;
const SCENARIO_NAME = "Short Stay Booking (1 Adult, 1 Night)";
  ...
  passengers: [
    {
      ...
      PaxType: 1,
      Age: 28,
      PassportNo: "IJ1234567",
      PassportIssueDate: "2019-01-01",
      PassportExpDate: "2029-01-01",
      Email: "neha.sharma@test.com",
      Phoneno: "+919876543250",
  ...
  try {
    ...
    results.steps.hotelSearch = {
      ...
      selectedHotel: {
        ...
        note: "Solo traveler, short stay (1 night)",
      },
    };
