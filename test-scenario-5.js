...
async function testScenario5() {
  console.log('\n' + '='.repeat(80));
  console.log('SCENARIO 5: International (Paris, 1 Adult, US)');
...
testScenario5().then(r => { console.log('='.repeat(80)); console.log(JSON.stringify(r, null, 2)); process.exit(r.status === 'PASSED' ? 0 : 1); });
