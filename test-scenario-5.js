...
async function testScenario5() {
  ...
  console.log(
    "Destination: Paris | Dates: 2026-01-05 to 2026-01-07 | Nationality: US",
  );
  ...
  try {
    ...
    console.log(
      `✅ Found ${searchRes.data.hotels.length} hotels | Hotel: ${hotel.hotelName} | Price: ${hotel.price?.offeredPrice} EUR`,
    );
    ...
    console.log(
      `✅ Room details retrieved | Price: ${hotel.price?.offeredPrice} EUR`,
    );
