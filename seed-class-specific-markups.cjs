...
async function seedClassSpecificMarkups() {
  ...
  try {
    ...
    if (deleteResult.rowCount > 0) {
      console.log(`🗑️  Removed ${deleteResult.rowCount} existing sample markup(s)\n`);
    }
    ...
    for (const markup of classSpecificMarkups) {
      ...
      console.log(`   Current Fare Range: ${markup.current_min_pct}% - ${markup.current_max_pct}%`);
      console.log(`   Bargain Fare Range: ${markup.bargain_min_pct}% - ${markup.bargain_max_pct}%\n`);
    ...
    console.log('═══════════════════════════════════════════════════════');
    console.log(`✨ SUCCESS! Created ${insertedCount} class-specific markup records`);
    console.log('═══════════════════════════════════════════════════════\n');
