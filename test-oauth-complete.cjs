...
const FRONTEND_URL = 'https://55e69d5755db4519a9295a29a1a55930-aaf2790235d34f3ab48afa56a.fly.dev';
...
async function testCompleteOAuthFlow() {
  ...
  try {
    ...
    try {
      ...
      console.log('📄 Response type:', callbackResponse.headers['content-type']);
