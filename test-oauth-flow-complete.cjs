  ...
  try {
    ...
    try {
      ...
      if (location && location.includes("accounts.google.com")) {
        ...
        console.log(
          `   ✅ client_id: ${params.get("client_id") ? "PRESENT" : "MISSING"}`,
        );
        console.log(
          `   ✅ redirect_uri: ${params.get("redirect_uri") ? "PRESENT" : "MISSING"}`,
        );
        console.log(
    ...
    try {
      const response = await axios.get(
        `${BASE_URL}/api/oauth/google/callback`,
        {
    ...
    console.log(
      '   - Bridge page showing "Authentication Successful" with user details',
    );
    ...
    console.log("========================");
    console.log(
      "Visit: https://55e69d5755db4519a9295a29a1a55930-aaf2790235d34f3ab48afa56a.fly.dev/oauth-test",
    );
    console.log(
      "This page has a dedicated OAuth test button with detailed logging.",
    );
  } catch (error) {
