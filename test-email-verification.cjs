...
const VERIFICATION_TOKEN =
  "fe3cafa8ad547490340a9d2f6bf23c646cd5bed0a53c33cd84f797df375ac72d";
...
async function verifyEmail() {
  ...
  return new Promise((resolve, reject) => {
    ...
    console.log(
      `URL: https://builder-faredown-pricing.onrender.com/api/auth/verify-email?token=${VERIFICATION_TOKEN.substring(0, 20)}...`,
    );
