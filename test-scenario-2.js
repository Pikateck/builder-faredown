...
async function testScenario2() {
  console.log('\n' + '='.repeat(80));
  console.log('SCENARIO 2: Domestic (Mumbai, 2 Adults + 2 Children)');
  console.log('='.repeat(80));
  try {
    const searchRes = await axios.post(`${API_BASE}/tbo/search`, {
      destination: 'Mumbai', cityId: 10449, countryCode: 'IN', checkIn: '2025-12-23', checkOut: '2025-12-25',
      rooms: [{ adults: 2, children: 2, childAges: [8, 12] }], currency: 'INR', guestNationality: 'IN'
    }, { timeout: 30000 });
    ...
    const roomRes = await axios.post(`${API_BASE}/tbo/room`, {
      ...
      checkInDate: '2025-12-23', checkOutDate: '2025-12-25', noOfRooms: 1
    }, { timeout: 30000 });
...
testScenario2().then(r => { console.log('='.repeat(80)); console.log(JSON.stringify(r, null, 2)); process.exit(r.status === 'PASSED' ? 0 : 1); });
