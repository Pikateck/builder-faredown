...
const url =
  "https://55e69d5755db4519a9295a29a1a55930-aaf2790235d34f3ab48afa56a.fly.dev/api/packages?departure_date=2025-10-01&return_date=2025-10-05&category=any&adults=2&destination=London%2C+United+Kingdom&destination_code=LON&destination_type=city&page=1";
    ...
    res.on("end", () => {
      try {
        ...
        console.log(
          ...
          !!(response.data && response.data.packages),
        );
