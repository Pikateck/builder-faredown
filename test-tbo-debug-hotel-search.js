...
async function testDebugHotelSearch() {
  console.log("╔═══════════════════════════════════════════════════════════════╗");
  console.log("║       TBO Debug Hotel Search - Spec Perfect Test             ║");
  console.log("╚═════════���═════════════════════════════════════════════════════╝");
  console.log("");
  ...
  try {
    ...
    if (response.data.auth) {
      ...
      console.log("🔑 TokenId:", auth.TokenId ? `${auth.TokenId.substring(0, 30)}...` : "NOT RECEIVED");
      console.log("");
    ...
    console.log("");
    console.log("╔═══════════════════════════════════════════════════════════════╗");
    console.log("║                  GETHOTELRESULT REQUEST SENT                   ║");
    console.log("╚═══════════════════════════════════════════════════════════════╝");
    console.log("");
    ...
    if (response.data.requestSent) {
      ...
      console.log("🔑 TokenId:", req.TokenId ? `${req.TokenId.substring(0, 30)}...` : "NOT SENT");
      console.log("");
      
      console.log("Full Request Payload:");
      console.log(JSON.stringify({
        ...req,
        TokenId: req.TokenId ? `${req.TokenId.substring(0, 30)}...` : req.TokenId
      }, null, 2));
    }

    console.log("");
    console.log("╔═══════════════════════════════════════════════════════════════╗");
    console.log("║                  GETHOTELRESULT RESPONSE                       ║");
    console.log("╚════════════════════════════���══════════════════════════════════╝");
    console.log("");
    ...
    if (response.data.response) {
      ...
      if (searchResponse.HotelSearchResult) {
        ...
        console.log("✅ HotelSearchResult.ResponseStatus:", result.ResponseStatus);
    ...
    const authWorked = response.data.auth?.Status === 1 || response.data.auth?.Status?.Code === 1;
    const searchWorked = response.data.response?.HotelSearchResult?.ResponseStatus === 1;
    ...
    if (authWorked && searchWorked) {
      ...
      console.log("");
      console.log("⚠️  Integration issue detected. Review logs above for details.");
    }
    console.log("");
