      ...
      roomTypes: [
        {
          ...
          description: "Twin bed, great city view",
          maxOccupancy: 2,
          size: "24 sqm",
        ...
        },
        {
          ...
          description: "King bed, upgraded view",
          maxOccupancy: 2,
          size: "28 sqm",
          bedTypes: ["1 King Bed"],
        ...
        },
        {
          ...
          description: "Suite with separate living area and ocean view",
          maxOccupancy: 3,
          size: "45 sqm",
        ...
        },
        {
          ...
          maxOccupancy: 4,
          size: "38 sqm",
          bedTypes: ["1 King Bed", "1 Twin Bed"],
          amenities: ["WiFi", "Air Conditioning", "TV", "Mini Bar"],
          images: [
        ...
        },
        {
          ...
          description: "Business-class room with lounge access",
          maxOccupancy: 2,
          size: "30 sqm",
          bedTypes: ["1 King Bed"],
          amenities: ["WiFi", "Air Conditioning", "TV", "Coffee Machine"],
          images: [
        ...
        },
        {
          ...
          description: "Best value standard double room",
          maxOccupancy: 2,
          size: "22 sqm",
