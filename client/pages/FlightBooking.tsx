...
import { flightsService, Flight, Passenger, ContactInfo } from "@/services/flightsService";
...
export default function FlightBooking({ flight: providedFlight }: FlightBookingProps) {
  ...
  const validateForm = (): boolean => {
    ...
    passengers.forEach((passenger, index) => {
      ...
      if (!passenger.dateOfBirth) {
        newErrors[`passenger_${index}_dateOfBirth`] = "Date of birth is required";
      }
    });
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center space-y-4">
          ...
          <div>
            ...
            <p className="text-gray-600">Please select a flight to continue with booking.</p>
                  ...
                  <div key={index} className="border rounded-lg p-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          className={errors[`passenger_${index}_firstName`] ? "border-red-500" : ""}
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          className={errors[`passenger_${index}_lastName`] ? "border-red-500" : ""}
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          className={errors[`passenger_${index}_dateOfBirth`] ? "border-red-500" : ""}
                        />
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={(value) => handlePassengerChange(index, "gender", value as "M" | "F")}
                        >
                          <SelectTrigger>
                            <SelectValue />
                          </SelectTrigger>
                    ...
                    {(flight.departure.country !== flight.arrival.country) && (
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 pt-4 border-t">
                        ...
                        <div>
                          <Label htmlFor={`passportExpiry_${index}`}>Passport Expiry</Label>
                          <Input
              ...
              <Card className="border-red-200 bg-red-50">
                <CardContent className="pt-6">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-red-800 font-medium">Booking Failed</span>
                  </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button 
                    ...
                    size="lg"
                  >
                    {isBooking ? "Processing..." : `Pay ${formatPrice(flight.price.breakdown.total)}`}
                  </Button>
