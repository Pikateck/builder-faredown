              ...
              <>
                ...
                <div className="bg-white rounded-lg border border-gray-200 mb-4">
                  ...
                  <div className="p-4 hidden md:block">
                        ...
                        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                          ...
                          {roomTypes.length > 0 && (
                            <div className="text-xs text-gray-600 mb-2">
                              {roomTypes[0].type} • {roomTypes[0].details}
                            </div>
                          )}
                    ...
                    {/* Compact One Smart Price Banner */}
                    <div className="mt-4 bg-white border border-gray-200 rounded-lg p-3 shadow-sm">
                      ...
                      <div className="text-xs text-[#666666] leading-relaxed">
                        Transparent pricing with all taxes included • AI Bargain Engine for live rates • Final Price Guarantee with no hidden fees
                      </div>
                    </div>
                  </div>
                </div>
