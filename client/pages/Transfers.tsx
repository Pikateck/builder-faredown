            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="bg-white rounded-3xl p-8 text-center shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 transform group">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Negotiate transfer upgrades instantly — from standard to
                  premium, from basic to luxury with our revolutionary AI
                  engine.
                </p>
              </div>
              ...
              <div className="bg-white rounded-3xl p-8 text-center shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 transform group">
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  overpaying for transfer services.
                </p>
              </div>
              ...
              <div className="bg-white rounded-3xl p-8 text-center shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 transform group">
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  are confirmed instantly with professional drivers.
                </p>
              </div>
              ...
              <div className="bg-white rounded-3xl p-8 text-center shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 transform group">
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  available 24/7 to secure your best transfer deals.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-shadow duration-300 hover:-translate-y-1 transform transition-transform">
                ...
                <blockquote className="text-gray-700 leading-relaxed italic">
                  "Saved ₹3,000 on my Dubai airport transfer! The bargaining
                  feature is amazing. Got luxury car service using Bargain™.
              ...
              <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-shadow duration-300 hover:-translate-y-1 transform transition-transform">
                ...
                <blockquote className="text-gray-700 leading-relaxed italic">
                  "Got premium transfer service in Singapore using Bargain™.
                  Faredown is revolutionary! Customer service is excellent."
                </blockquote>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-shadow duration-300 hover:-translate-y-1 transform transition-transform">
                ...
                <blockquote className="text-gray-700 leading-relaxed italic">
                  "Easy transfer booking process and instant confirmations.
                  Professional drivers and safe rides. Will use again!"
                </blockquote>
              </div>
            </div>
          </div>
