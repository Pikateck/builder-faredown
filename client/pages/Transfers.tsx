...
export default function Transfers() {
  ...
  // State for transfers functionality
          ...
          <div className="px-4">
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600 text-sm mb-3">
                Book safe, comfortable transfers with professional drivers and competitive rates. From airport pickups to city transfers.
              </p>
            </div>
        ...
        <div className="block md:hidden bg-white border-t border-gray-200 fixed bottom-0 left-0 right-0 z-50">
          <div className="grid grid-cols-5 h-16">
            ...
            >
              ...
              <span className="text-xs text-[#003580] font-medium">Transfers</span>
            </Link>
            <Link
              to="/account"
              className="flex flex-col items-center justify-center space-y-1 touch-manipulation min-h-[48px] w-full"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="bg-white rounded-3xl p-8 text-center shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 transform group">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Negotiate transfer upgrades instantly — from standard to premium, from basic to luxury with our revolutionary AI engine.
                </p>
              </div>
              ...
              <div className="bg-white rounded-3xl p-8 text-center shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 transform group">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Set your price and let Faredown negotiate for you — no more overpaying for transfer services.
                </p>
              </div>
              ...
              <div className="bg-white rounded-3xl p-8 text-center shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 transform group">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Your data is encrypted with bank-level security and bookings are confirmed instantly with professional drivers.
                </p>
              </div>
              ...
              <div className="bg-white rounded-3xl p-8 text-center shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 transform group">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Skip the back and forth. Our AI works faster, smarter, and is available 24/7 to secure your best transfer deals.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-shadow duration-300 hover:-translate-y-1 transform transition-transform">
                ...
                <blockquote className="text-gray-700 leading-relaxed italic">
                  "Saved ₹3,000 on my Dubai airport transfer! The bargaining feature is amazing. Got luxury car service using Bargain™. Faredown is revolutionary! Customer service is excellent."
                </blockquote>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-shadow duration-300 hover:-translate-y-1 transform transition-transform">
                ...
                <blockquote className="text-gray-700 leading-relaxed italic">
                  "Got premium transfer service in Singapore using Bargain™. Faredown is revolutionary! Customer service is excellent."
                </blockquote>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-shadow duration-300 hover:-translate-y-1 transform transition-transform">
                ...
                <blockquote className="text-gray-700 leading-relaxed italic">
                  "Easy transfer booking process and instant confirmations. Professional drivers and safe rides. Will use again!"
                </blockquote>
              </div>
            </div>
          </div>
