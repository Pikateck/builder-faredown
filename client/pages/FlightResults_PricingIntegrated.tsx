...
export default function FlightResults() {
  ...
  const calculateFlightPricing = useCallback(
    async (flight: any) => {
      ...
      try {
        ...
        const pricingParams = createPricingParams(
          "air",
          {
            origin,
            destination,
  ...
  const calculateAllFlightPricing = useCallback(
    async (flightList: any[]) => {
        ...
        {loading && (
          <div className="text-center py-8">
            <div className="text-lg">
              Finding best flights and calculating live pricing...
            </div>
