          ...
          <div className="px-8 py-6 space-y-8">
            <section>
              <div className="space-y-4 text-gray-700 leading-relaxed">
                <p>
                  This Cookie Policy explains how <strong>Faredown Bookings and Travels Pvt Ltd</strong> ("we", "us", or "our") uses cookies and similar technologies when you visit our website www.faredown.com (the "Service"). It explains what these technologies are and why we use them, as well as your rights to control our use of them.
                </p>
                <p>
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <p>
                  Cookies allow us to recognize your device and store some information about your preferences or past actions to enhance your experience on our website.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li><strong>Functionality:</strong> To make our website work properly and provide essential features</li>
                  ...
                  <li><strong>Marketing:</strong> To show you relevant advertisements and measure their effectiveness</li>
                </ul>
              </div>
            </section>
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="text-sm text-gray-600 space-y-2">
                      ...
                      <ul className="space-y-1">
                        ...
                        <li>• <a href="https://www.google.com/settings/ads" className="text-blue-600 hover:text-blue-800 underline" target="_blank" rel="noopener noreferrer">Google Ads Settings</a></li>
                        <li>• <a href="https://www.facebook.com/help/568137493302217" className="text-blue-600 hover:text-blue-800 underline" target="_blank" rel="noopener noreferrer">Facebook Ad Preferences</a></li>
                      </ul>
                    </div>
                  </CardContent>
                </Card>
            ...
            <section>
              ...
              <div className="bg-yellow-50 border-l-4 border-yellow-500 p-4">
                <p className="text-yellow-700">
                  <strong>Please note:</strong> If you disable cookies, some features of our website may not work properly. This may include:
                </p>
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  ...
                  <li><strong>Marketing Cookies:</strong> Usually stored for 12-24 months</li>
                </ul>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <div className="text-gray-700 space-y-2">
                  <p><strong>Email:</strong> privacy@faredown.com</p>
                  <p><strong>Address:</strong> Faredown Bookings and Travels Pvt Ltd</p>
                  <p><strong>Support:</strong> <Link to="/support" className="text-blue-600 hover:text-blue-800 underline">Visit our Help Center</Link></p>
                </div>
              </div>
            </section>
            ...
            <div className="border-t pt-6 mt-8">
              ...
              <p className="text-sm text-gray-500 mt-2">
                This Cookie Policy is part of our <Link to="/privacy-policy" className="text-blue-600 hover:text-blue-800 underline">Privacy Policy</Link>.
              </p>
            </div>
          </div>
        </div>
