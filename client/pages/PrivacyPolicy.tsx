          ...
          <div className="px-8 py-6 space-y-8">
            <section>
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed">
                ...
                <p>
                  This website is published and maintained by <strong>Faredown Bookings and Travels Pvt Ltd</strong> ("Faredown"). The Privacy Policy is applicable to the websites of Faredown including www.faredown.com, which also comprises of the mobile site, Smartphone App Platforms such as iOS, Android, Windows (all together referred to as "Site").
                </p>
                <p>
                  This privacy policy does not apply to the websites of our business partners, corporate affiliates or to any other third parties, even if their websites are linked to the site. We recommend you to review the respective privacy statements of the other parties with whom you interact.
                </p>
                <p>
                  By browsing, visiting, accessing and/or using the services on this Site (or searching for any of the pages on this Site), the customer ("You") explicitly consents and agrees to our Privacy Policy laid out herein. You also agree that the information furnished by you is lawful, true and correct and does not violate or infringe any laws. In case of any violations, infringement, furnishing of wrongful or unauthorized information, Faredown shall not be liable for the same.
                </p>
              </div>
            </section>

            <section>
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Information Categories</h3>
              <div className="space-y-4 text-gray-700">
                <p>We categorise information about you (collectively referred to as "Personal Information") as follows:</p>
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <Card>
                    <CardContent className="p-4">
                      <h4 className="font-semibold text-gray-900 mb-2">Profiling Information</h4>
                  ...
                  <Card>
                    <CardContent className="p-4">
                      <h4 className="font-semibold text-gray-900 mb-2">Service Usage</h4>
                      <ul className="text-sm space-y-1">
                  ...
                  <Card>
                    <CardContent className="p-4">
                      <h4 className="font-semibold text-gray-900 mb-2">Log Information</h4>
                      <ul className="text-sm space-y-1">
                        <li>• Web requests</li>
                        <li>• IP address</li>
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">2. Right To Collect</h2>
              <div className="space-y-4 text-gray-700">
                <p>
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li>We need your identity details, contact details, banking information and account history to manage our relationship with you and provide Services to you.</li>
                  <li>We use certain of your information in an aggregated form to compile statistical and demographical profiles for our business and marketing activities.</li>
                  <li>To determine and verify the Service Charges payable by you and to administer our relationship with you.</li>
                  <li>To comply with any statutory or regulatory requirement.</li>
                </ul>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-700">
                <p>
                  Some of our own websites use "cookies" so that we can provide you with more customized information when you return to our website. "Cookies" are used to store user preferences and to track user trends, so as to enhance your interactive experience and generally improve our Services to you.
                </p>
                <p>
                  You can set your browser to notify you when you are sent a "cookie", giving you the chance to decide whether or not to accept it. If you do accept a "cookie", you thereby agree to our use of any Personal Information collected by us using that Cookie.
                </p>
              </div>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">3. General Exceptions</h2>
              <div className="space-y-4 text-gray-700">
                <p>
            ...
            <section>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <p className="text-gray-700">
                  If you are no longer interested in receiving e-mail announcements and other marketing information from us, or you want us to remove any PII that we have collected about you, please contact us at{" "}
