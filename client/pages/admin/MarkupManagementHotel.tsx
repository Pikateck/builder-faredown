...
const HOTEL_CHAINS = [
  'Marriott', 'Hilton', 'Hyatt', 'Radisson', 'ITC Hotels', 'Taj Hotels',
  'Oberoi', 'Leela', 'Accor', 'Four Seasons', 'Ritz Carlton', 'Sheraton',
  'Holiday Inn', 'Crowne Plaza', 'Novotel', 'Ibis', 'OYO', 'Zostel'
];
...
export default function MarkupManagementHotel() {
  ...
  const [selectedMarkup, setSelectedMarkup] = useState<HotelMarkup | null>(null);
  ...
  const filteredMarkups = markups.filter(markup => {
    ...
    const matchesCity = selectedCity === 'all' || markup.city.toLowerCase().includes(selectedCity.toLowerCase());
    const matchesCategory = selectedCategory === 'all' || markup.roomCategory === selectedCategory;
  ...
  const handleCheckInDaysChange = (day: string, checked: boolean) => {
    ...
    if (checked) {
      ...
      setFormData({...formData, checkInDays: currentDays.filter(d => d !== day)});
    }
  };
  ...
  const MarkupForm = ({ isEdit = false }) => (
    <div className="space-y-6 max-h-[70vh] overflow-y-auto">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <Select 
              ...
              onValueChange={(value) => setFormData({...formData, hotelChain: value})}
            >
              <SelectTrigger>
        ...
        <div>
          ...
          <Select 
            ...
            onValueChange={(value) => setFormData({...formData, roomCategory: value as HotelMarkup['roomCategory']})}
          >
            <SelectTrigger>
              <SelectValue />
            </SelectTrigger>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <Select 
              ...
              onValueChange={(value) => setFormData({...formData, markupType: value as HotelMarkup['markupType']})}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div>
            ...
            <Input
              ...
              placeholder={formData.markupType === 'percentage' ? 'e.g., 8.5' : 'e.g., 2500'}
            />
          </div>
        </div>
      ...
      {/* Booking Conditions */}
      <div className="space-y-4">
        <h3 className="text-lg font-medium border-b pb-2">Booking Conditions</h3>
            ...
            {DAYS_OF_WEEK.map(day => (
              <div key={day.value} className="flex items-center space-x-2">
                <input
                  ...
                  onChange={(e) => handleCheckInDaysChange(day.value, e.target.checked)}
                  className="rounded"
                />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) => setFormData({...formData, maxStay: parseInt(e.target.value) || 30})}
              placeholder="e.g., 30"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <Select 
            ...
            onValueChange={(value) => setFormData({...formData, seasonType: value as HotelMarkup['seasonType']})}
          >
            <SelectTrigger>
              <SelectValue />
            </SelectTrigger>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <Select 
              ...
              onValueChange={(value) => setFormData({...formData, userType: value as HotelMarkup['userType']})}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
