...
export default function CurrencyManagement() {
  ...
  const toggleCurrencyStatus = (currencyId: string) => {
    setCurrencies(currencies.map(c => 
      c.id === currencyId 
        ? {...c, status: c.status === 'active' ? 'inactive' : 'active', lastUpdated: new Date().toISOString()}
        : c
    ));
  };
  ...
  const TrendIndicator = ({ trend, change }: { trend: Currency['trend'], change: number }) => {
    const trendConfig = {
  ...
  const CurrencyForm = ({ isEdit = false }) => (
    <div className="space-y-6 max-h-[70vh] overflow-y-auto">
      ...
      <div className="space-y-4">
        <h3 className="text-lg font-medium border-b pb-2">Currency Information</h3>
      ...
      <div className="space-y-4">
        <h3 className="text-lg font-medium border-b pb-2">Exchange Rate Configuration</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <Select 
              ...
              onValueChange={(value) => setFormData({...formData, precision: parseInt(value)})}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div>
            ...
            >
              ...
              <SelectContent>
                <SelectItem value="Exchange Rate API">Exchange Rate API</SelectItem>
              ...
              <div className="mb-4 p-3 bg-blue-50 rounded-lg">
                <div className="flex items-center justify-between text-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <span>Last rates update: {new Date(lastRateUpdate).toLocaleString()}</span>
                  </div>
                        ...
                        <TableCell>
                          <div className="space-y-1">
                            <div className="font-medium">
                              1 INR = {currency.exchangeRate.toFixed(currency.precision)} {currency.symbol}
                            </div>
                            <div className="text-xs text-gray-600">
                              Base: {currency.baseRate.toFixed(4)} | Markup: {currency.markup.toFixed(4)}
                            </div>
                          </div>
                        </TableCell>
                        <TableCell>
                          <TrendIndicator trend={currency.trend} change={currency.change24h} />
                        </TableCell>
                        <TableCell>
                          <div className="space-y-1">
                        ...
                        <TableCell>
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              ...
                              <DropdownMenuItem onClick={() => toggleCurrencyStatus(currency.id)}>
                              ...
                              {!currency.isDefault && (
                                <DropdownMenuItem onClick={() => setDefaultCurrency(currency.id)}>
