...
const ROLES = {
  ...
  finance: {
    ...
    icon: DollarSign,
    permissions: ['view_reports', 'manage_payments', 'view_bookings', 'manage_vat']
  },
  sales: {
    name: 'Sales',
    color: 'bg-blue-100 text-blue-800',
    icon: TrendingUp,
    permissions: ['view_bookings', 'manage_promos', 'view_reports', 'manage_markup']
  },
  marketing: {
    name: 'Marketing',
  ...
  const handleSaveUser = () => {
    if (selectedUser) {
      ...
      const newUser: User = {
        ...
        lastLogin: '',
        permissions: ROLES[formData.role as keyof typeof ROLES]?.permissions || []
      };
                        ...
                        <TableRow key={user.id}>
                          <TableCell>
                            <div className="flex items-center space-x-3">
                              ...
                              <div>
                                <p className="font-medium">{user.title} {user.firstName} {user.lastName}</p>
