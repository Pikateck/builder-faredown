  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="hidden md:block">
        ...
        {/* Upgrade & Ancillaries Module */}
        <section className="py-12 bg-white border-b border-gray-100">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-3">
                Bargain for More Than Just Base Price
              </h2>
              <p className="text-gray-600">
                Get better upgrades, rooms, and extras at prices you control
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center p-6 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-900">Seat Upgrades</h3>
                <p className="text-sm text-gray-600 mb-3">
                  Bargain for seat upgrades from Economy to Business Class
                </p>
              ...
              <div className="text-center p-6 bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl border border-purple-200">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-900">Hotel Room Upgrades</h3>
                <p className="text-sm text-gray-600 mb-3">
                  Get better rooms with views, categories, and suites
                </p>
              ...
              <div className="text-center p-6 bg-gradient-to-br from-green-50 to-green-100 rounded-xl border border-green-200">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-900">Travel Extras</h3>
                <p className="text-sm text-gray-600 mb-3">
                  Book meals, baggage, and insurance at better prices
                </p>
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-[1280px] mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 text-lg">
                Discover the most searched destinations and get the best deals
              </p>
            </div>
              ...
              {[
                ...
                <div key={index} className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow cursor-pointer">
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-lg font-bold text-[#003580]">{destination.price}</span>
