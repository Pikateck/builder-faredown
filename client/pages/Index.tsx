        ...
        {showMobileMenu && (
          <div className="md:hidden bg-blue-800 border-t border-blue-600 absolute w-full z-50">
            <div className="px-4 py-4 space-y-2">
              {/* Mobile Admin Test Section */}
              <div onClick={() => setShowMobileMenu(false)}>
                <AdminTestButton variant="mobile" />
              </div>
              <Link
                to="/flights"
          ...
          <div className="grid grid-cols-3 gap-2 mb-3">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center justify-between bg-gray-50 rounded-lg px-3 py-4 border touch-manipulation w-full"
              >
                <div className="flex items-center space-x-2">
              ...
              {showClassDropdown && (
                <div className="absolute bottom-full mb-2 left-0 right-0 bg-white border border-gray-200 rounded-lg shadow-xl p-2 z-[9999]">
                  {[
                    "Economy",
                    "Premium Economy",
                    "Business",
