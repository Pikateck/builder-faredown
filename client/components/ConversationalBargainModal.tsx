  ...
  return shouldRenderModal ? (
    ...
    >
      ...
      >
        ...
        <div
          className="flex-1 overflow-y-auto p-2 sm:p-3 mobile-chat-scroll bg-gray-50 w-full"
          style={{
            minHeight: isMobileDevice() ? "120px" : "40vh",
            maxHeight: isMobileDevice() ? "calc(100dvh - 280px)" : "60vh",
            overflowY: "auto",
            overflowX: "hidden",
