...
export function UnifiedLandingPage({ module, tagline, searchPanel }: UnifiedLandingPageProps) {
  ...
  return (
    <div>
      ...
      <section className="hidden md:block py-16 bg-gradient-to-b from-white to-gray-50">
      ...
      {/* Mobile Hero Section */}
      <section className="md:hidden py-12 bg-gradient-to-b from-gray-50 to-white">
        <div className="px-4">
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-2">
              Why Faredown {module.charAt(0).toUpperCase() + module.slice(1)}?
            </h2>
            <p className="text-gray-600 text-sm">
              AI-powered {config.serviceType} with live bargaining
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div className="bg-white rounded-xl p-4 shadow-md border border-gray-100">
              ...
              <h3 className="font-bold text-gray-900 text-sm mb-1">AI Bargaining</h3>
              <p className="text-gray-600 text-xs">Live {config.upgradeType}</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-4 shadow-md border border-gray-100">
              ...
              <h3 className="font-bold text-gray-900 text-sm mb-1">Best Rates</h3>
              <p className="text-gray-600 text-xs">Premium for less</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-4 shadow-md border border-gray-100">
              ...
              <h3 className="font-bold text-gray-900 text-sm mb-1">Secure</h3>
              <p className="text-gray-600 text-xs">Instant confirmations</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-4 shadow-md border border-gray-100">
              ...
              <p className="text-gray-600 text-xs">Expert help</p>
            </div>
          </div>
        </div>
      </section>
