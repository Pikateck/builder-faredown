...
export const ReviewModal: React.FC<ReviewModalProps> = ({ 
  ...
  const validateForm = (): boolean => {
    ...
    if (form.stay_start && form.stay_end && new Date(form.stay_start) >= new Date(form.stay_end)) {
  ...
  const isFormValid = form.overall_rating > 0 && 
        ...
        <div className="space-y-6 pb-4">
          ...
          <div>
            ...
            <div className="mt-2">
              <StarRating
                ...
                onRatingChange={(rating) => setForm(prev => ({ ...prev, overall_rating: rating }))}
                size="lg"
              />
            </div>
          ...
          <div>
            ...
            <div className="flex justify-between items-center mt-1">
              ...
              <p className="text-xs text-gray-500 ml-auto">
                {form.body.length}/2000 {form.body.length < 50 && `(minimum 50)`}
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <Label htmlFor="reviewer_name" className="text-sm font-medium text-gray-900">
                Your name *
              </Label>
              <Input
                id="reviewer_name"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <Label htmlFor="stay_start" className="text-sm font-medium text-gray-900">
                Stay start date *
              </Label>
              <Input
                id="stay_start"
                ...
                onChange={(e) => setForm(prev => ({ ...prev, stay_start: e.target.value }))}
            ...
            <div>
              <Label htmlFor="stay_end" className="text-sm font-medium text-gray-900">
                Stay end date *
              </Label>
              <Input
                id="stay_end"
                type="date"
                value={form.stay_end}
                onChange={(e) => setForm(prev => ({ ...prev, stay_end: e.target.value }))}
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              {TRIP_TYPES.map((type) => (
                <Button
                  ...
                  onClick={() => setForm(prev => ({ ...prev, trip_type: type }))}
                >
                  {type}
                </Button>
              ))}
