...
/**
 * Scenario 2: Mumbai Hotel Booking
 * - Destination: Mumbai, India
 * - Guests: 2 Adults
 * - Duration: 2 nights (Dec 15-17, 2025)
 * - Focus: Different destination, longer stay
 */
...
const SCENARIO_ID = 2;
const SCENARIO_NAME = "Mumbai Hotel Booking (2 Adults, 2 Nights)";
...
const TEST_PARAMS = {
  ...
  passengers: [
    ...
    },
    {
      ...
      PaxType: 1,
      Age: 32,
      PassportNo: "CD1234567",
      PassportIssueDate: "2019-01-01",
      PassportExpDate: "2029-01-01",
      Email: "priya.kumar@test.com",
