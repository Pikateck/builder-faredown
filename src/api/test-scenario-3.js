...
async function testScenario3() {
  console.log('\n' + '='.repeat(80));
  console.log('SCENARIO 3: Domestic (2 Rooms, 1 Adult each)');
...
testScenario3().then(result => { console.log('='.repeat(80)); console.log(JSON.stringify(result, null, 2)); process.exit(result.status === 'PASSED' ? 0 : 1); });
