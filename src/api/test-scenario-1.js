...
async function testScenario1() {
  ...
  console.log(
    "Destination: Mumbai | Dates: 2025-12-20 to 2025-12-22 | Nationality: IN",
  );
  ...
  try {
    ...
    console.log(
      `✅ Found ${searchRes.data.hotels.length} hotels | Hotel: ${hotel.hotelName} | Price: ${hotel.price?.offeredPrice} ${hotel.price?.currencyCode}`,
    );
