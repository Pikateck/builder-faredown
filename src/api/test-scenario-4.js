...
async function testScenario4() {
  console.log('\n' + '='.repeat(80));
  console.log('SCENARIO 4: Domestic (2 Rooms, Mixed: 1A+2C + 2A)');
...
testScenario4().then(result => { console.log('='.repeat(80)); console.log(JSON.stringify(result, null, 2)); process.exit(result.status === 'PASSED' ? 0 : 1); });
